    ...
    <View style={st.screen}>
      ...
      <View style={st.header}>
        <Link href="/(tabs)/home/perfil" asChild>
          <Pressable style={st.backBtn}><ThemedText style={st.backTxt}>←</ThemedText></Pressable>
        </Link>
...
const st = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 8, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#E5E7EB',
  },
  backBtn: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center' },
  backTxt: { fontSize: 20, fontWeight: '800', color: '#0F172A' },
